...
function UnderConstruction() {
  return (
    <div className="flex items-center justify-center bg-notpage bg-cover bg-center-bottom min-h-[66vh]">
      <div className="text-center p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
        ...
        <p className="text-gray-300 mb-6 ">Çok kısa sürede sizinle olacağız.</p>
