      ...
      <div className="flex flex-col justify-center items-center my-10 w-[90%]">
        ...
        <div className="text-center text-xl my-2">
          <p>
            ...
            daha iyi bir dünya yaratma arzusuyla başladı. Fiziksel, zihinsel ve
            duygusal esenliğe öncelik veren bir zihniyet değişimine ihtiyaç
        ...
        <div className="text-center text-xl my-2">
          <p>
            ...
            tasarlıyoruz. Benzersiz çözümlerimiz denge, güven ve konforu teşvik
            ederek en iyi hâlini ortaya çıkarmanı amaçlamaktadır.
          </p>
        </div>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div>
              <p className="text-center text-xl my-2">
                Marcus Schmieke, Healy World’ün kurucusu ve mucididir ve şirket
                2019 yılında faaliyete geçtiğinde şirketin vizyonunu belirleyen
                kişidir. O zamandan bu yana Marcus kendini, bütünsel esenliği
                dünyanın dört bir yanındaki bireyler için erişilebilir kılmak
                üzere tasarlanan teknolojiyi geliştirip ilerletmeye adamıştır.
              </p>
            </div>

            <div>
              <p className="text-center text-xl my-2">
                Heidelberg ve Hannover’de fizik ve felsefe eğitimi alan Marcus,
                dünyanın manevi yönüne dair derin içgörüler edinmek ve bilinç
                hakkında bilgi edinmek için manastırlarda bir keşiş hayatı
                yaşadığı Hindistan’a bir seyahat gerçekleştirdi. Alman fizikçi
                Burkhard Heim, Rus fizikçi Nikolai Kozyrev ve diğer uzman bilim
                adamlarının çalışmalarından aldığı ilhamla Marcus, bilgi ve
                uzmanlığını Healy World ürünlerinin arkasındaki temel konsepte
                entegre etti.
              </p>
            </div>
