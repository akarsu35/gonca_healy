  ...
  return (
    <div className="flex justify-center items-center flex-col mt-8 ">
      ...
      <div className="w-[95%] min-h-[600px] mt-4 flex flex-col md:flex-row items-center justify-center">
        <div className=" w-[20rem] md:w-[60rem] items-center justify-center m-4 shadow-customl rounded-xl">
        ...
        <div className="flex w-[20rem] md:w-[60rem] p-4 md:mr-2 items-center justify-center  rounded-xl">
